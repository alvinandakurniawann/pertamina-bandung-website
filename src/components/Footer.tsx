        ...
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mb-4 tracking-wider leading-relaxed text-gray-400">
              Melayani kebutuhan energi masyarakat Bandung dan sekitarnya dengan
              komitmen kualitas dan pelayanan terbaik.
            </p>
            {/* Sosmed icons */}
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold border-b border-gray-600 mb-4">
              Tautan Cepat
            </h4>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              <p>
                Jl. Wirayuda Timur No.1, Lebakgede, Kecamatan Coblong, Kota
