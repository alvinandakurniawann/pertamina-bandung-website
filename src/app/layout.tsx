          ...
          <nav className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <Link href="/" className="flex items-center space-x-2">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-800">PERTAMINA</h1>
                  <p className="text-sm text-gray-600">Cabang Bandung</p>
                </div>
              </Link>
        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="md:col-span-2">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold">PERTAMINA</h3>
                    <p className="text-sm text-gray-400">Cabang Bandung</p>
                  </div>
                </div>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
              <p>&copy; 2024 Pertamina Cabang Bandung. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </body>
